...
impl Screen for GeneratePasswordScreen {
    fn draw_window(cursive: &mut cursive::Cursive) {
        ...
        let content = LinearLayout::new(Orientation::Vertical)
            .child(ListView::new().child(
                "length: ",
                ResizedView::with_fixed_width(10, TextArea::new().with_name("password_len")),
            ))
            .child(PaddedView::lrtb(
                ...
                0,
                HideableView::new(
                    TextView::new("generating password...").h_align(cursive::align::HAlign::Center),
                )
                .hidden()
            ...
            .child(PaddedView::lrtb(
                ...
                0,
                1,
                HideableView::new(TextView::new("Entropy").h_align(cursive::align::HAlign::Center))
                    .hidden()
                    .with_name("entropy"),
            ))
            .child(
                        ...
                        Button::new_raw("Generate Password", |x| {
                            ...
                            if !content.is_empty() && content.parse::<i32>().is_ok() {
                                ...
                                if len < 50 && len > 0 {
                                    ...
                                    entropyref.get_inner_mut().set_content(format!(
